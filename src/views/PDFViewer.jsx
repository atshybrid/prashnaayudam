    ...
    return (
        <>
            ...
            <div className='max-sm:h-[640px] h-screen w-full xl:w-[70%] xl:mx-auto relative'>
                <div className={`size-8 ${color ? '' : 'bg-[#2E3192]'} absolute z-10 top-1/2 left-8`} style={color ? { backgroundColor: color } : {}}>
                ...
                <div className={`size-8 ${color ? '' : 'bg-[#2E3192]'} absolute z-10 top-1/2 right-8`} style={color ? { backgroundColor: color } : {}}>
